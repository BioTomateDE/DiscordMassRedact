...
fn main() -> Result<(), String> {
    ...
    */
    ...
    loop {
        let length = random_range(0..2000);
        println!("Generating quote for length {}", length);
        let quote = generate_shakespeare(length, QUOTES);
        println!("Thy generate quote shall be: \n{}", quote);
    }
